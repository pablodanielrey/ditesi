...
with open('/tmp/client_secrets.json','w') as f:
    ...
    json.dump({"web": {
      ...
      "redirect_uris": os.environ['DITESI_URL'] + "/oidc_callback"
    }}, f)
...
app = Flask(__name__, static_url_path='/src/ditesi/web')
app.debug = True
app.config['SECRET_KEY'] = 'algo-secreto'
app.config['SESSION_COOKIE_NAME'] = 'ditesi_session'
...
app.config['OIDC_ID_TOKEN_COOKIE_NAME'] = 'ditesi_oidc'
